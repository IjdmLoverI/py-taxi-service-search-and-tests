...
class TestViews(TestCase):
    ...
    def test_toggle_assign_to_car(self):
        ...
        response = self.client.get(reverse('taxi:car-detail', kwargs={'pk': car_id}))
...
class CarListViewTestCase(TestCase):
    def setUp(self):
        ...
        self.car1 = Car.objects.create(model="Toyota Camry", manufacturer=self.manufacturer1)

    def test_search_by_model(self):
        response = self.client.get(reverse("taxi:car-list"), {"search": "Toyota"})
        self.assertEqual(response.status_code, 200)
